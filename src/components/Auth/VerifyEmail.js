    ...
    <div className='w-[100vw] h-[100vh] flex justify-center items-center'>
      <div className='w-[60%]  shadow-2xl  flex flex-col rounded-3xl justify-center items-center '>
        ...
        <div className='w-[28%] text-center text-[#174b3a] font-roboto mt-1 font-medium'>
          <p>{t("We have sent a reset email to abc1234@gmail.com")}</p>
        </div>
        <form action="">
          <div className=''>
            <button className=' bg-[#f19a3e] m-auto p-4 rounded-3xl tracking-widest w-[100%] transition-all duration-200 hover:scale-105 text-white flex justify-center text-xl mb-6 mt-4'>{t("Reset password")}</button>
          </div>
        </form>
      </div>
    </div>
