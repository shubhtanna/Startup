  ...
  return (
    <div className='w-10/12 flex flex-col justify-center space-y-8 p-4 mx-auto'>
      <div className='flex flex-col text-[#174B3A] '>
        <p className='text-4xl mt-14 leading-10 font-semibold text-[#174B3A]'>{t("Here are nearby Shopkeepers")} !</p>
        <p className='mt-2 text-[15px] text-[#174B3A] '>{t("We have customized the list of shopkeepers based on your location")}!</p>
      </div>
